...
public final class CosmeticService {
    ...
    public CosmeticService(Supplier<Content> content, PlayerDataStore<PackPlayerProfile> store, NameplateService nameplateService) {
    ...
    private String activeStyle(Player player, PackPlayerProfile profile, CosmeticCategory category) {
