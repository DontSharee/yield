...
/**
 * A zone's unlock price - any combination of Coins, Gems, and turned-in
 ...
 */
public record ZoneUnlockCost(BigInteger coins, BigInteger gems, List<ItemCost> items) {

    public static final ZoneUnlockCost FREE = new ZoneUnlockCost(BigInteger.ZERO, BigInteger.ZERO, List.of());

    public boolean isFree() {
        return coins.signum() <= 0 && gems.signum() <= 0 && items.isEmpty();
    }
